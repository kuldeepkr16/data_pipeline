...
export const PipelineGrid: React.FC<PipelineGridProps> = ({
    ...
    selectedTimeRange, setSelectedTimeRange, onAdd, onRefresh
}) => {
            ...
            <div className="flex flex-wrap justify-between items-center bg-gray-900/40 p-4 rounded-xl border border-white/5 backdrop-blur-sm gap-4">
                ...
                <div className="flex items-center gap-3">
                    {selectedTimeRange !== null && (
                        <div className="px-4 text-xs text-indigo-300 font-medium hidden md:block border-r border-white/10 mr-2 pr-4">
                ...
                {configs.map((config, index) => {
                    ...
                    return (
                        <PipelineCard
                            ...
                            config={config}
                            latestRun={latestRun}
                            loadedStats={loadedStats[config.source_tablename] || 0}
