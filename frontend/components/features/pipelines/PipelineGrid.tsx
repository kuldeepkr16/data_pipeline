...
interface PipelineGridProps {
    ...
    loadedStats: Record<string, number>;
...
export const PipelineGrid: React.FC<PipelineGridProps> = ({
    ...
    return (
        <div className="space-y-6 bg-stars">
            {/* Time Range Selector */}
            <div className="flex flex-wrap justify-between items-center bg-gray-900/40 p-4 rounded-xl border border-white/5 backdrop-blur-sm gap-4">
