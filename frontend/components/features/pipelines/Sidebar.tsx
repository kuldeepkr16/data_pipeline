...
interface SidebarProps {
    activeSection: 'details' | 'configure' | 'schema' | 'transform';
    setActiveSection: (section: 'details' | 'configure' | 'schema' | 'transform') => void;
}
...
const Sidebar: React.FC<SidebarProps> = ({ activeSection, setActiveSection }) => {
    ...
    return (
        <aside className="w-64 bg-black/40 border-r border-white/5 p-4 hidden lg:block">
